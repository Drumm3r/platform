...
class PromotionIndividualCodeRedeemerTest extends TestCase
{
     ...
     * @group promotions
     */
    public function testSubscribeToCheckoutOrderPlaced(): void
    {
     ...
     * @group promotions
     */
    public function testOnOrderPlaced(): void
    {
        $checkoutOrderPlacedEvent = new CheckoutOrderPlacedEvent(Context::createDefaultContext(new AdminApiSource('test')), $order, TestDefaults::SALES_CHANNEL);
